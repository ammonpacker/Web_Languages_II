...
<div id="content" class="container-fluid">
     <div class="card">
	<div class="card-body">
		<h4 class="card-title">Delete <?php echo $found['first'].' '.$found['last'];?>? </h4>
			<form id="myForm" action="delete.php" method="post" enctype="multipart/form-data">
				<div class="form-group" id="form">
					...
					?>
                   			...
                   			<input type="hidden" name="photo" value="employees/<?php echo $found['image']; ?>"/>   
					<br><button type="submit" class="btn btn-danger btn-lg">Delete</button>
					<a href="manage.php" class="btn btn-success btn-lg" role="button">Cancel</a>
				</div>
			</form>
	</div>
